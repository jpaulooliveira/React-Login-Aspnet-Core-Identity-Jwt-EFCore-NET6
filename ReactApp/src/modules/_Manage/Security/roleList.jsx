...
class RoleList extends React.Component {
    ...
    render() {
        ...
        return (
            <Card 
                title={ "id=manage.roles.title" }
                extra={ 
                    <>
                        <Button type="primary" onClick={() => this.props.history.push("/manage/security/role")}><PlusOutlined /> Add Role</Button>
                        <Button type="primary" onClick={() => this.loadGrid()}><PlusOutlined /> Get Roles</Button>
                    </>
                 }>
