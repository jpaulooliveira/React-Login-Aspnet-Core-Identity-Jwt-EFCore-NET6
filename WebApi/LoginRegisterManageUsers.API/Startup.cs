...
using LoginRegisterManageUsers.Services.User;
using Microsoft.AspNetCore.Authorization;
using LoginRegisterManageUsers.Components.Authorization;
using Newtonsoft.Json.Serialization;
using Newtonsoft.Json;
using LoginRegisterManageUsers.Services.CoreServices;
using LoginRegisterManageUsers.Helpers;
using static LoginRegisterManageUsers.Api.Components.Authorization.SystemClaims;

namespace LoginRegisterManageUsers
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
                ...
                c.SwaggerDoc("v1", 
                    new OpenApiInfo { 
                        ...
                        Contact = new OpenApiContact
                        {
                            Name = "Some Developer",
                            Email = string.Empty,
                            Url = new Uri("https://LoginRegisterManageUsers.com"),
                        },
                    });

                var filePath = Path.Combine(System.AppContext.BaseDirectory, "LoginRegisterManageUsers.API.xml");
            ...
            services.AddAuthorization(options => {
                //options.AddPolicy(Permissions.Role.View, policy => policy.RequireRole("Administrator"));
                options.AddPolicy(Permissions.Role.View, policy =>
                {
                    policy.RequireClaim("YourCustomClaimType");
                });
            });            
